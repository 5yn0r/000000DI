...
* 🔐 Passionné par la **Cybersécurité**, avec un focus sur le **Blue Team & la sécurité défensive**
...
> *Ici, tu peux ajouter tes propres projets avec des descriptions.*
> 
> Exemple :
...
* 🔐 Approfondir la **cybersécurité défensive (Blue Team)** : Analyse de logs, Threat Hunting, Reverse Engineering
...
* 📫 **Email** : [Ton Email Ici] (Pense à l'ajouter si tu veux être contacté)
* 🔗 **LinkedIn** : [Ton Profil LinkedIn] (Optionnel)
